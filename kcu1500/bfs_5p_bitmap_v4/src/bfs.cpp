...
#pragma HLS STREAM variable=rpa_stream                  depth=1024
#pragma HLS STREAM variable=cia_stream                  depth=256
#pragma HLS STREAM variable=cia_done_stream             depth=4

#pragma HLS STREAM variable=next_frontier_stream0       depth=1024
#pragma HLS STREAM variable=next_frontier_stream1       depth=1024
#pragma HLS STREAM variable=next_frontier_stream2       depth=1024
#pragma HLS STREAM variable=next_frontier_stream3       depth=1024
#pragma HLS STREAM variable=next_frontier_stream4       depth=1024
#pragma HLS STREAM variable=next_frontier_stream5       depth=1024
#pragma HLS STREAM variable=next_frontier_stream6       depth=1024
#pragma HLS STREAM variable=next_frontier_stream7       depth=1024
