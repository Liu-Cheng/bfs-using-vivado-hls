...
int main(int argc, char **argv) {
    ...
    std::vector<int, aligned_allocator<int>> ciao_b0(ciao_b0_size);
    std::vector<int, aligned_allocator<int>> ciao_b1(ciao_b1_size);
    std::vector<int, aligned_allocator<int>> ciao_b2(ciao_b2_size);
    std::vector<int, aligned_allocator<int>> ciao_b3(ciao_b3_size);
