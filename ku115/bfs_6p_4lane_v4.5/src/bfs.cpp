		...
		)
{
	...
	hash_tag_dt hash_table4[HASH_SIZE];
	hash_tag_dt hash_table5[HASH_SIZE];
	hash_tag_dt hash_table6[HASH_SIZE];
	hash_tag_dt hash_table7[HASH_SIZE];
	hash_tag_dt hash_table8[HASH_SIZE];
	hash_tag_dt hash_table9[HASH_SIZE];
	hash_tag_dt hash_table10[HASH_SIZE];
	hash_tag_dt hash_table11[HASH_SIZE];
	hash_tag_dt hash_table12[HASH_SIZE];
	hash_tag_dt hash_table13[HASH_SIZE];
	hash_tag_dt hash_table14[HASH_SIZE];
	hash_tag_dt hash_table15[HASH_SIZE];
   	...
   	if(level == 0){
        ...
        #pragma HLS pipeline II=1
			...
			hash_table4[i] = HASH_TAG_INIT_VAL;
			hash_table5[i] = HASH_TAG_INIT_VAL;
			hash_table6[i] = HASH_TAG_INIT_VAL;
			hash_table7[i] = HASH_TAG_INIT_VAL;

			hash_table8[i] = HASH_TAG_INIT_VAL;
			hash_table9[i] = HASH_TAG_INIT_VAL;
			hash_table10[i] = HASH_TAG_INIT_VAL;
			hash_table11[i] = HASH_TAG_INIT_VAL;

			hash_table12[i] = HASH_TAG_INIT_VAL;
			hash_table13[i] = HASH_TAG_INIT_VAL;
			hash_table14[i] = HASH_TAG_INIT_VAL;
			hash_table15[i] = HASH_TAG_INIT_VAL;
		}
#ifndef SW_EMU
	}
#endif
    ...
    #pragma HLS pipeline
		...
		if(ciao_empty != 1){
			...
			hash_tag_dt hash_val4 = hash_table4[hash_idx];
			hash_tag_dt hash_val5 = hash_table5[hash_idx];
			hash_tag_dt hash_val6 = hash_table6[hash_idx];
			hash_tag_dt hash_val7 = hash_table7[hash_idx];

			hash_tag_dt hash_val8 = hash_table8[hash_idx];
			hash_tag_dt hash_val9 = hash_table9[hash_idx];
			hash_tag_dt hash_val10 = hash_table10[hash_idx];
			hash_tag_dt hash_val11 = hash_table11[hash_idx];

			hash_tag_dt hash_val12 = hash_table12[hash_idx];
			hash_tag_dt hash_val13 = hash_table13[hash_idx];
			hash_tag_dt hash_val14 = hash_table14[hash_idx];
			hash_tag_dt hash_val15 = hash_table15[hash_idx];
