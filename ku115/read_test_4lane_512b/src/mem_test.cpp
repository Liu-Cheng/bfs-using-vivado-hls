...
#pragma HLS INTERFACE m_axi port=input0 offset=slave bundle=gmem00
#pragma HLS INTERFACE m_axi port=input1 offset=slave bundle=gmem01
#pragma HLS INTERFACE m_axi port=input2 offset=slave bundle=gmem02
#pragma HLS INTERFACE m_axi port=input3 offset=slave bundle=gmem03
#pragma HLS INTERFACE m_axi port=result0 offset=slave bundle=gmem20
#pragma HLS INTERFACE m_axi port=result1 offset=slave bundle=gmem21
#pragma HLS INTERFACE m_axi port=result2 offset=slave bundle=gmem22
#pragma HLS INTERFACE m_axi port=result3 offset=slave bundle=gmem23
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
	...
	int read_base[4] = {0x20000, 0x30000, 0x40000, 0x50000};
#pragma HLS dataflow
