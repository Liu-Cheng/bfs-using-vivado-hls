...
int main(int argc, char **argv) {
	...
	char level = 0;
	auto hr_begin = std::chrono::high_resolution_clock::now();
	...
	//elapsedTime = (end - begin)*1000.0/CLOCKS_PER_SEC;
	auto duration = std::chrono::duration_cast<std::chrono::milliseconds>(hr_end - hr_begin).count();
