...
int main(int argc, char **argv) {
    ...
    cl_mem_ext_ptr_t depth_b2_ext;
    cl_mem_ext_ptr_t depth_b3_ext;
    ...
    depth_b2_ext.flags = XCL_MEM_DDR_BANK2; 
    depth_b3_ext.flags = XCL_MEM_DDR_BANK3; 
    ...
    depth_b2_ext.obj = hwDepth_b2.data(); 
    depth_b3_ext.obj = hwDepth_b3.data(); 
    ...
    depth_b2_ext.param = 0; 
    depth_b3_ext.param = 0; 
    ...
    cl::Buffer dev_depth_b0(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR,
            (vertexNum/4) * sizeof(char), &depth_b0_ext);
	cl::Buffer dev_depth_b1(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR,
            (vertexNum/4) * sizeof(char), &depth_b1_ext);
	cl::Buffer dev_depth_b2(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR,
            (vertexNum/4) * sizeof(char), &depth_b2_ext);
	cl::Buffer dev_depth_b3(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR,
            (vertexNum/4) * sizeof(char), &depth_b3_ext);
    ...
    inBufVec.push_back(dev_depth_b2);
    inBufVec.push_back(dev_depth_b3);
	...
	depthBufVec.push_back(dev_depth_b2);
	depthBufVec.push_back(dev_depth_b3);
