...
int main(int argc, char **argv) {
	...
	// In order to make the memory access more efficient, we change the rpao storage 
	// format. Instead of using the compact format, we store with the following manner
	// with more memory overhead. (vertex 0 starting index, length), 
	// (vertex 1 starting index, length), ...
