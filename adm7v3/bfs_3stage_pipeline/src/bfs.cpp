...
bfs_stage1(frontier_size, depth_inspect_stream, inspect_done_stream, 
		frontier_stream, vertex_num, level);
bfs_stage2(depth_for_update, frontier_stream, inspect_done_stream, rpao, ciao, 
