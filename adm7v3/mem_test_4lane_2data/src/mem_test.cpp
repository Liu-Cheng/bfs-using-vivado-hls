...
#pragma HLS dataflow
	...
	read_mem(input2, burst_num, read_base2, stride, result2);
	read_mem(input3, burst_num, read_base3, stride, result3);
	write_mem(output0, burst_num, write_base0, inc, stride);
	write_mem(output1, burst_num, write_base1, inc, stride);
	write_mem(output2, burst_num, write_base2, inc, stride);
	write_mem(output3, burst_num, write_base3, inc, stride);
}
}
