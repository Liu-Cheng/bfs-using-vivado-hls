...
{
#pragma HLS INTERFACE m_axi port=depth_for_inspect offset=slave bundle=gmem0 latency=64 num_read_outstanding=32 max_read_burst_length=16
#pragma HLS INTERFACE m_axi port=depth_for_expand offset=slave bundle=gmem1 latency=64 num_read_outstanding=32 max_read_burst_length=16
#pragma HLS INTERFACE m_axi port=depth_for_update offset=slave bundle=gmem2
#pragma HLS INTERFACE m_axi port=rpao offset=slave bundle=gmem3 latency=32 num_read_outstanding=32 max_read_burst_length=2
#pragma HLS INTERFACE m_axi port=ciao offset=slave bundle=gmem4 latency=64 num_read_outstanding=32 max_read_burst_length=16
...
#pragma HLS STREAM variable=rpao_stream depth=64
