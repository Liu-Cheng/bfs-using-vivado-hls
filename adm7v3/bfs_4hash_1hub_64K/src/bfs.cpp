...
//#endif
	...
	tag_dt visited_table[HASH_SIZE];
...
//#endif
    ...
    #pragma HLS pipeline
		...
		if(visited_stream.empty() != 1){
			...
			visited_table[hash_idx] = hash_tag;
		}
...
//#endif
			...
			tag_dt hash_val  = visited_table[hash_idx];

			if(hash_val != hash_tag && hash_val0 != hash_tag 
					&& hash_val1 != hash_tag && hash_val2 != hash_tag 
					&& hash_val3 != hash_tag){
